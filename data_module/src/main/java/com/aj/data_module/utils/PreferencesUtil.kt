package com.aj.data_module.utils
 ...
 * @Description:   SharedPreferences bao'c
 * @Author:         zhy
 * @CreateDate:     2020/9/11 11:37
 */
object PreferencesUtil {
    private const val name = "APP_WanAndroid"
    private val prefs: SharedPreferences by lazy { AppContext.context.getSharedPreferences(name, Context.MODE_PRIVATE) }
